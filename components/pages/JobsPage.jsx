...
const ROLES = [
  ...
  },
  {
    ...
    summary: "Own the growth engine that brings creators, businesses, and cities onto VibeCircles. You'll identify and scale the acquisition channels that compound --- not just ones that spike.",
  ...
  },
  {
    ...
    summary: "Be the pulse of VibeCircles on your campus. You're not promoting an app --- you're launching a movement. Campus Ambassadors are VibeCircles's most powerful distribution channel.",
    responsibilities: ["Drive creator signups and map adoption among students on your campus", "Organize and host VibeCircles-branded events and activations", "Build relationships with student organizations, campus media, and event planners", "Create authentic content from campus life and post to VibeCircles", "Submit weekly reports: signups, events, content engagement", "Identify and onboard local businesses and venues near campus", "Be the face of VibeCircles in your city"],
    ...
    techStack: ["VibeCircles app", "Notion (reporting)", "Canva (content)"],
  ...
  },
  {
    ...
    summary: "Help onboard, support, and scale the creator ecosystem that is the lifeblood of VibeCircles. You'll work directly with the Head of Creator Partnerships to find, activate, and retain the creators who make cities come alive.",
    ...
    techStack: ["VibeCircles app", "Notion", "Airtable", "Slack"],
                          ...
                          {applyOpen === i && (
                            <div style={{ marginTop: "20px", padding: "20px", background: "rgba(0,0,0,0.02)", border: `1px solid ${dc}30`, borderRadius: "4px", animation: "fadeUp .3s ease" }}>
                              ...
                              <label style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "12px" }}>
                                <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "11px", color: C.dimmer, letterSpacing: "1px", textTransform: "uppercase" }}>Why VibeCircles?</span>
