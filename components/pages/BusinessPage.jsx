      ...
      <section className="sec-pad" style={{ background: C.bg2 }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <Reveal style={{ marginBottom: "52px" }}>
            ...
            <h2 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "clamp(30px,5vw,54px)", color: C.white, lineHeight: 1, marginTop: "16px" }}>
              Everything you need
              <br />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: "24px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              {BIZ_TOOLS.map((t, i) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "15px", color: active === i ? C.orange : C.white }}>{t.title}</div>
            ...
            <div key={active} style={{ padding: "40px", background: "rgba(255,255,255,0.02)", border: `1px solid ${C.border}`, borderRadius: "4px", animation: "fadeIn .3s ease", position: "relative", overflow: "hidden" }}>
      ...
      <section className="sec-pad-sm" style={{ background: C.bg3 }}>
        <Reveal>
          <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "48px 52px", background: `linear-gradient(135deg,rgba(255,107,0,0.12) 0%,rgba(255,45,120,0.06) 100%)`, border: `1px solid ${C.orange}25`, borderRadius: "4px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "24px", flexWrap: "wrap" }}>
            <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "clamp(24px,4vw,44px)", color: C.white, lineHeight: 1 }}>
              Ready to make your
              <br />
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <button
                ...
                style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "14px", letterSpacing: "3px", padding: "13px 32px", background: C.orange, color: C.bg, border: "none", borderRadius: "2px", cursor: "pointer", transition: "box-shadow .2s" }}
