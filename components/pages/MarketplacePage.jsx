              ...
              <div style={{ border: `1px solid ${C.border}`, background: "rgba(0,0,0,0.02)", borderRadius: "6px", padding: w < 600 ? "28px" : "44px", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 2 }}>
                  ...
                  <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                    <button type="button" onClick={() => openWaitlist("Creator Marketplace Waitlist")} className="vc-btn vc-btn--primary vc-btn--sm">Join Waitlist</button>
                    <button type="button" onClick={() => setActiveTab("Brand")} className="vc-btn vc-btn--outline-muted vc-btn--sm">I’m a Brand Instead</button>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal>
              <div style={{ border: `1px solid ${C.border}`, background: "rgba(0,0,0,0.02)", borderRadius: "6px", padding: w < 600 ? "28px" : "44px", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 2 }}>
                  ...
                  <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                    <button type="button" onClick={() => openWaitlist("Brand Marketplace Waitlist")} className="vc-btn vc-btn--primary vc-btn--sm">Join Waitlist</button>
                    <button type="button" onClick={() => setActiveTab("Creator")} className="vc-btn vc-btn--outline-muted vc-btn--sm">I’m a Creator Instead</button>
                  </div>
                </div>
              </div>
            </Reveal>
