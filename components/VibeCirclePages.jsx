      ...
      <div style={{background:C.bg,border:`1px solid ${C.orange}35`,borderRadius:"6px",padding:"48px",maxWidth:"480px",width:"100%",position:"relative",animation:"fadeUp .3s ease",maxHeight:"90vh",overflowY:"auto"}}>
        ...
        {step===1?(
          <>
            ...
            <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:"14px",color:C.dim,lineHeight:1.7,marginBottom:"28px"}}>VibeCircle is launching city by city. Be first in your city when we open access.</p>
            {/* Role Selector */}
    ...
    <footer style={{background:C.bg2,borderTop:`1px solid ${C.border}`}}>
      <div style={{maxWidth:"1100px",margin:"0 auto",padding:w<600?"48px 20px":"56px 64px"}}>
        <div style={{display:"grid",gridTemplateColumns:w<600?"1fr 1fr":w<960?"1fr 1fr 1fr":"1fr 1fr 1fr 1fr 1fr",gap:"36px",marginBottom:"52px"}}>
          <div>
            <button onClick={()=>go("home")} style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"22px",letterSpacing:"3px",color:C.orange,background:"none",border:"none",cursor:"pointer",marginBottom:"14px",display:"block"}}>VIBECIRCLE</button>
...
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
const TESTIMONIALS=[
  {quote:"VibeCircle changed how I grow as a creator. I booked my first brand deal in 3 days and my local following tripled in a month.",name:"Jordan Lee",role:"Music Creator - Johannesburg",avatar:"MIC",color:C.orange},
  ...
  {quote:"Nothing has ever connected me to real people in my city like VibeCircle. It's the only platform where I feel seen.",name:"Mia Torres",role:"Visual Artist - Cape Town",avatar:"ART",color:C.purple},
];
